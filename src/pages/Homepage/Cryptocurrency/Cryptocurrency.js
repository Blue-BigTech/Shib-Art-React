...
export const Cryptocurrency = () => {
  ...
  const handleBuyNowClick = async () => {
    try {
      ...
      console.log('currentWContractAddress', currentContractAddress.testnet)
      console.log('w______currentContractAddress', currentWContractAddress.testnet)

      console.log('tokenContract', tokenContract?.methods)
      ...
      .then( async res=>{
        ...
        await contract?.methods.contribute(addressSet.WETH, value).send({value: res, from: account})
          .then(res2 => {
            console.log("Buy Now res", res2);
          })
      })
